...
$env:TARGET_ENVIRONMENT_REGION = "westus2" # tests are be pointed to local service instance
$env:ROOT = Split-Path $MyInvocation.MyCommand.Path
$env:SLN_NAME = "Mossharbor.ActivityStreamsr.sln"
$env:SLN_RUNSETTINGS_NAME = "Mossharbor.ActivityStreams.runsettings"
$env:NUGETVERSIONPROPSPATH = $env:Root
$env:NUGETVERSIONPROPSPATH += "\.build\dependency.version.props"
$env:VERSIONFILE = ${env:ROOT}
$env:VERSIONFILE +=  "\Mossharbor.ActivityStreams\Package.nuspec"
